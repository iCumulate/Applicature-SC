...
import {CrowdsaleAgent as CAgent} from '../agent/CrowdsaleAgent.sol';
import '../Ownable.sol';
...
contract Crowdsale is Ownable {
    ...
    function setCrowdsaleAgent(CAgent _crowdsaleAgent) public onlyOwner {
