...
contract('CrowdsaleImpl', accounts => {
    ...
    beforeEach(async () => {
        ...
        pricingStrategy = await USDDateTiersPricingStrategy.new(
            [///privateSale
                ...
                0,// uint256 airdropCap;
                0,// uint256 soldTierTokens;
                0,// uint256 bonusTierTokens;
                50,// uint256 discountPercents;
                50,// uint256 bonusPercents;
    ...
    describe('Crowdsale', () => {
        ...
        it('should allow to make external contribution', async () => {
            ...
            await crowdsale.externalContribution(contributor, 1000, {
